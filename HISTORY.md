...
|---|---|---|---|
| crude-oil | +1 | Leaning bullish | -2 → -1 → -1 → -1 → -1 → -1 → -1 → 0 → 0 → +1 |
| natural-gas | 0 | Neutral / mixed | -1 → -1 → -1 → -2 → -2 → -2 → -2 → -2 → -1 → 0 |
| gold | 0 | Neutral / mixed | +1 → +1 → +1 → +1 → +1 → +1 → +1 → +1 → +1 → 0 |
| silver | -1 | Leaning bearish | +1 → +2 → +2 → +2 → +2 → +2 → +1 → +1 → +1 → -1 |
| copper | +1 | Leaning bullish | 0 → +1 → +1 → +1 → +1 → +2 → +2 → +2 → +2 → +1 |
| wheat | +2 | Bullish | +2 → +2 → +2 → +2 → +2 → +2 → +2 → +2 → +2 → +2 |
| corn | +2 | Bullish | +1 → +2 → +2 → +2 → +2 → +2 → +2 → +2 → +2 → +2 |
| soybeans | +1 | Leaning bullish | -1 → 0 → 0 → 0 → +1 → +1 → +1 → +1 → +1 → +1 |
| aluminum | +1 | Leaning bullish | +1 |

## Run-by-run scores (last 42 runs, newest first)

| Run (UTC) | crude-oil | natural-gas | gold | silver | copper | wheat | corn | soybeans | aluminum |
|---|---|---|---|---|---|---|---|---|---|
| 2026-07-09T13:55Z | +1 | 0 | 0 | -1 | +1 | +2 | +2 | +1 | +1 |
...
| Run (UTC) | gold-silver | corn-soybeans | corn-wheat | crude-natgas | gold-copper | copper-aluminum |
|---|---|---|---|---|---|---|
| 2026-07-09T13:55Z | +1 | +1 | 0 | +1 | -1 | 0 |
